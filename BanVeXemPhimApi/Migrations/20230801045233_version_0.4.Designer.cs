...
namespace BanVeXemPhimApi.Migrations
{
    ...
    [Migration("20230801045233_version_0.4")]
            ...
            modelBuilder.Entity("BanVeXemPhimApi.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 391, DateTimeKind.Local).AddTicks(6573),
            ...
            modelBuilder.Entity("BanVeXemPhimApi.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 388, DateTimeKind.Local).AddTicks(1825),
                            ...
                            NumberView = 0,
                            Price = 80000.0,
                            ReleaseDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(8340),
                            Time = 115,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9399),
                            Description = "Bối cảnh One Piece Film Red diễn ra ở hòn đảo âm nhạc Elegia, nơi diva nổi tiếng bậc nhất thế giới tên Uta thực hiện buổi biểu diễn trực tiếp đầu tiên trước công chúng. Uta đứng trên sân khấu với một ước mơ giản dị rằng ” Âm nhạc của tôi sẽ khiến cho thế giới hạnh phúc”. Đằng sau hình ảnh cô ca sĩ sở hữu giọng hát được đánh giá là ở “Đẳng cấp hoàn toàn khác” là một thân thế vô cùng bí ẩn được che giấu. Băng hải tặc Mũ Rơm và các fan khác của Uta từ nhiều thế lực khác nhau như hải tặc lẫn hải quân đều đã cùng tề tựu về buổi biểu diễn này. Biến cố bắt đầu ngay khi sự thật kinh hoàng được tiết lộ rằng Uta chính là “con gái của Shanks”. Luffy và Uta lần đầu tiên hội ngộ sau lần gặp gỡ vào 12 năm trước tại Làng Foosha.",
                            ...
                            NumberView = 0,
                            Price = 80000.0,
                            ReleaseDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9409),
                            Time = 115,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9412),
                            Description = "Bối cảnh One Piece Film Red diễn ra ở hòn đảo âm nhạc Elegia, nơi diva nổi tiếng bậc nhất thế giới tên Uta thực hiện buổi biểu diễn trực tiếp đầu tiên trước công chúng. Uta đứng trên sân khấu với một ước mơ giản dị rằng ” Âm nhạc của tôi sẽ khiến cho thế giới hạnh phúc”. Đằng sau hình ảnh cô ca sĩ sở hữu giọng hát được đánh giá là ở “Đẳng cấp hoàn toàn khác” là một thân thế vô cùng bí ẩn được che giấu. Băng hải tặc Mũ Rơm và các fan khác của Uta từ nhiều thế lực khác nhau như hải tặc lẫn hải quân đều đã cùng tề tựu về buổi biểu diễn này. Biến cố bắt đầu ngay khi sự thật kinh hoàng được tiết lộ rằng Uta chính là “con gái của Shanks”. Luffy và Uta lần đầu tiên hội ngộ sau lần gặp gỡ vào 12 năm trước tại Làng Foosha.",
                            ...
                            NumberView = 0,
                            Price = 80000.0,
                            ReleaseDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9414),
                            Time = 115,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9416),
                            Description = "Bối cảnh One Piece Film Red diễn ra ở hòn đảo âm nhạc Elegia, nơi diva nổi tiếng bậc nhất thế giới tên Uta thực hiện buổi biểu diễn trực tiếp đầu tiên trước công chúng. Uta đứng trên sân khấu với một ước mơ giản dị rằng ” Âm nhạc của tôi sẽ khiến cho thế giới hạnh phúc”. Đằng sau hình ảnh cô ca sĩ sở hữu giọng hát được đánh giá là ở “Đẳng cấp hoàn toàn khác” là một thân thế vô cùng bí ẩn được che giấu. Băng hải tặc Mũ Rơm và các fan khác của Uta từ nhiều thế lực khác nhau như hải tặc lẫn hải quân đều đã cùng tề tựu về buổi biểu diễn này. Biến cố bắt đầu ngay khi sự thật kinh hoàng được tiết lộ rằng Uta chính là “con gái của Shanks”. Luffy và Uta lần đầu tiên hội ngộ sau lần gặp gỡ vào 12 năm trước tại Làng Foosha.",
                            ...
                            NumberView = 0,
                            Price = 80000.0,
                            ReleaseDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9417),
                            Time = 115,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Cast = "",
                            CreatedDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9418),
                            Description = "Bối cảnh One Piece Film Red diễn ra ở hòn đảo âm nhạc Elegia, nơi diva nổi tiếng bậc nhất thế giới tên Uta thực hiện buổi biểu diễn trực tiếp đầu tiên trước công chúng. Uta đứng trên sân khấu với một ước mơ giản dị rằng ” Âm nhạc của tôi sẽ khiến cho thế giới hạnh phúc”. Đằng sau hình ảnh cô ca sĩ sở hữu giọng hát được đánh giá là ở “Đẳng cấp hoàn toàn khác” là một thân thế vô cùng bí ẩn được che giấu. Băng hải tặc Mũ Rơm và các fan khác của Uta từ nhiều thế lực khác nhau như hải tặc lẫn hải quân đều đã cùng tề tựu về buổi biểu diễn này. Biến cố bắt đầu ngay khi sự thật kinh hoàng được tiết lộ rằng Uta chính là “con gái của Shanks”. Luffy và Uta lần đầu tiên hội ngộ sau lần gặp gỡ vào 12 năm trước tại Làng Foosha.",
                            ...
                            NumberView = 0,
                            Price = 80000.0,
                            ReleaseDate = new DateTime(2023, 8, 1, 11, 52, 33, 389, DateTimeKind.Local).AddTicks(9423),
                            Time = 115,
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("BanVeXemPhimApi.Models.OrderTicket", b =>
                {
                    ...
                    b.Property<string>("TicketReceiptCode")
                        .HasColumnType("longtext");
